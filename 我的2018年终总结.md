...
三月份中旬，我在简书发表了我的第一个系列分析文章的开篇：[Java集合源码分析之开篇](https://www.jianshu.com/p/407afb4a267a)，并在随后的近两月的时间内从基础的数据结构知识，到抽象接口的定义，再到具体的实现，对Java的集合类进行了全方位的介绍，以及全部技术细节的解析。6月19日，该文发表于**鸿洋**的公众号后，为我带来了第一波关注。下面是这一系列文章的简书地址，在我的公众号上也有相同的信息：

[Java集合源码分析之开篇](https://www.jianshu.com/p/407afb4a267a)
...
六月份，我着手准备研究Android Framework相关的代码。然而经过一个月的努力，我发现脱离于实际需求而研究这部分代码是漫无目的的，除了能在面试时多说几句外，并不能用于指导工作。所以在研究了Activity的启动、View的绘制以及Handler的原理之后，我暂停了这方面的学习。如果大家能给我一些指导建议，我一定十分感激。下面是我已经研究过的部分文章，还不成熟所以公众号上暂时没有：

[Android源码分析之开篇](https://www.jianshu.com/p/f56ec2f00237)

[Android源码分析之准备：U盘安装Ubuntu系统实记（UEFI）](https://www.jianshu.com/p/2c4de69fd33c)

[Android源码分析之准备：Ubuntu环境下工具安装与使用](https://www.jianshu.com/p/269ce8877806)

[Android源码分析之准备：AOSP国内下载](https://www.jianshu.com/p/4a19e5da05f1)

[Android源码分析之准备：AOSP编译](https://www.jianshu.com/p/9e50a21c0c30)

[Android源码分析之准备：Android Studio调试AOSP代码](https://www.jianshu.com/p/a19dcb06cd53)

[Android源码分析之App启动流程（一）](https://www.jianshu.com/p/6885b4558ba2)

[Android源码分析之App启动流程（二）](https://www.jianshu.com/p/ad807c71e1ba)

[Android源码分析之Activity启动与View绘制流程（一）](https://www.jianshu.com/p/a13e3a3259f3)

[Android源码分析之Activity启动与View绘制流程（二）](https://www.jianshu.com/p/dc6eeeb735e2)

[Android源码分析之Touch事件分发机制](https://www.jianshu.com/p/2007a7b33af1)

[Android源码分析之Handler](https://www.jianshu.com/p/7103d8bc2a29)

## 3. 数据结构与算法

八月份，我觉得自己应该学习一些更广泛而通用的知识，例如网络、计算机原理、数据结构和算法等，这些知识无疑能终身受用。鉴于之前对集合的研究，接下来的很长时间我都投入到了数据结构和算法方面的学习，了解了链表、哈希表、二叉树、二叉查找树以及图等方面的知识，也掌握了各种排序和查找的原理与实现。这些知识使我认识到编码不只是无趣的搭建界面和"CURD"，计算机还有许多有趣而伟大的思想正在等待我们挖掘和探索。以下是我对这些知识的理解，希望能够帮助大家理解算法：

[数据结构与算法概述](https://www.jianshu.com/p/1bfbe921e099)

[数据结构之线性表](https://www.jianshu.com/p/0ce37caf4ae6)

[数据结构之栈与队列](https://www.jianshu.com/p/dab3b3275552)

[数据结构之树与二叉树](https://www.jianshu.com/p/e716df01af07)

[数据结构与算法之查找](https://www.jianshu.com/p/49865267c623)

[数据结构之B树与B+树](https://www.jianshu.com/p/cf7dba86c391)

[数据结构与算法之字符串匹配](https://www.jianshu.com/p/37cd549dd3fd)

[数据结构与算法之排序](https://www.jianshu.com/p/f0fb2fa0db18)

[数据结构之图的概念和存储](https://www.jianshu.com/p/9b263135be59)

[数据结构之图的遍历](https://www.jianshu.com/p/60eb50dbfc39)

[数据结构与算法之最小生成树](https://www.jianshu.com/p/be377686dcf6)

[数据结构与算法之最短路径](https://www.jianshu.com/p/66b3aa9ad847)

[数据结构与算法之拓扑排序](https://www.jianshu.com/p/fe800fd1611b)

[数据结构与算法之关键路径](https://www.jianshu.com/p/cef14f70ec92)

赶在2018年的尾巴，我所学的这些理论知识终于派上用场，我开始在LeetCode上练习算法，一来检验自己的学习成果，二来加深对算法在实际应用中的理解。算法的精妙在于，通过合理的设计的确能大大提高计算机的效率，在我们漫长的职业生涯中一定有机会接触各种算法，所以这部分知识的确 ***很有必要掌握***。这些题目的解题思路都会在我的微信公众号：**大大纸飞机** 同步，且会延续到2019年。现在公众号上已经有5篇相关文章了，更多内容正在继续更新中，很快这部分内容也会同步到简书。

<div align="center"><img src ="./leet.jpg" /><br/>LeetCode</div>
